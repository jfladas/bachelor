...
<template>
  ...
  <Transition name="overlay-fade" appear>
    <div v-if="onboardingLoaded && !onboardingCompleted" class="onboarding-shell" :style="hueVariables"
      @mouseenter="setOnboardingPopupInteractive(true)" @mouseleave="setOnboardingPopupInteractive(false)">
      <main class="window">
